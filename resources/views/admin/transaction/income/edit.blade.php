      ...
      <div class="row">
          <div class="col-12">
            ...
            <div class="card card-primary">
              <!-- form start -->
              <form role="form" method="post" action="{{ url('admin/income/update/'.$data['id']) }}">
                {{ csrf_field() }}
                <input type="text" name="old_category_id" value="{{$data['master']['category_id']}}" style="display:none">
                <input type="text" name="trx_income_id" value="{{$data['trx_income_id']}}" style="display:none">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="date" required name="entry_date" class="form-control" id="exampleInputText" value={{$data['entry_date']}}>
                  </div>
                  <div class="form-group">
