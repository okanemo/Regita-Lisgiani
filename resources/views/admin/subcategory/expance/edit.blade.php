			...
			<div class="row">
					<div class="col-12">
						...
						<div class="card card-primary">
							<!-- form start -->
							<form role="form" method="post" action="{{ url('admin/expance-subcategory/update/'.$data['id']) }}">
								{{ csrf_field() }}
								<div class="card-body">
								...
								<div class="form-group">
										...
										<select class="custom-select" name="category_id" required>
											...
											<option value="{{$key['id']}}" @if($data['category_id']==$key['id']) selected @endif>{{$key['name']}}</option>
											@endforeach
										</select>
									</div>
									<div class="form-group">
